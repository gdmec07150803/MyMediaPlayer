package cn.edu.gdmec.w07150837.mymediaplayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rew = (ImageButton) this.findViewById(R.id.rew);
        pause = (ImageButton) this.findViewById(R.id.pause);
        start = (ImageButton) this.findViewById(R.id.start);
        ff = (ImageButton) this.findViewById(R.id.ff);

        play_time = (TextView) this.findViewById(R.id.play_time);
        all_time = (TextView) this.findViewById(R.id.all_time);
